...
require.paths.unshift(__dirname + "/node-github.git/lib");
require.paths.unshift(__dirname + "/node-github.git/support/async/lib");
require.paths.unshift(__dirname + "/node-github.git/support/oauth/lib");
